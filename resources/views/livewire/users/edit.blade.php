<form wire:submit.prevent="submit" class="w-full">
    ...
    <div class="flex items-center justify-end mt-6 -mx-4">
        <div class="flex items-center mx-4 ">
            <input wire:model.lazy="superadmin" id="superadmin" type="checkbox" class="cursor-pointer form-checkbox w-4 h-4 text-indigo-600 transition duration-150 ease-in-out" />
            <label for="superadmin" class="block ml-2 text-sm text-gray-900 leading-5 cursor-pointer">
                Super Admin
            </label>
        </div>
