...
<div class="w-full p-6 sm:p-10 bg-white shadow">
    <form wire:submit.prevent="submit" class="w-full" x-data="{ submitting: false }">
        ...
        <div class="flex flex-col mt-4  overflow-x-hidden">
            <div class="">
                ...
                <div wire:ignore class="mt-1 rounded-md shadow-sm">
                    <select
                        class="select2 block w-full @error('selectedRoles') border-red-300 text-red-900 placeholder-red-300 focus:border-red-300 focus:shadow-outline-red @enderror"
                        multiple required>
        ...
        <div class="flex items-center justify-end mt-6 -mx-4" @submitting.window="submitting = true">
            ...
            <button type="submit" x-text="submitting ? 'Please wait...' : 'Create Administrator'" :disabled="submitting"
